...
export type CatalogPageSeo = { title: string; description: string };
...
export type CatalogGame = {
  ...
  sortOrder: number; isVisible: boolean; pageSections?: CatalogPageSection[]; coverPath?: string; pageIntro?: string; pageRules?: CatalogPageRules | null; pageSeo?: CatalogPageSeo | null;
};
