...
export default function PartyPlayRankingPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        if (!cancelled) setError("Nie udało się pobrać rankingu PartyPlay.");
      } finally {
    ...
    <main className="min-h-screen bg-[#050713] px-5 py-10 text-white">
      ...
      <section className="relative z-10 mx-auto max-w-5xl">
        ...
        <section className="mt-5 rounded-3xl border border-cyan-300/10 bg-cyan-300/[.025] p-5 text-xs leading-5 text-zinc-500">
          Ranking PartyPlay jest osobny od rankingu Łowców w Polowaniu na Milionera.
